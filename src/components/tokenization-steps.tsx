    ...
    <div className="space-y-6 mt-10">
      <div className="space-y-4">
        ...
        <div className="flex items-center">
          ...
          <button className="relative mx-1  bg-[#AD1AAF] text-white px-5 py-2 text-lg font-medium transition-all  hover:shadow-lg h-[55px]">
            ...
            <span className="relative z-10  font-oxaniummedium flex items-center space-x-2">
              Tokenize Bet
      ...
      <div className="space-y-4">
        <div className="space-y-2">
          <h4 className="font-medium font-oxaniummedium text-white">
            Why Tokenize Your Bet?
          </h4>
          <ul className="space-y-2 text-sm text-gray-400 font-oxaniumregular">
            <li>
