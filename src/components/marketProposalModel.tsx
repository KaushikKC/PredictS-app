    ...
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-[#140C1F] bg-opacity-60">
      <div className="relative bg-gradient-to-br from-white/10 to-white/5 backdrop-blur-xl rounded-xl p-8 w-[90%] max-w-[800px] text-white">
        ...
        <div className="flex justify-between items-center mb-6">
          <h2 className="text-2xl font-oxaniumsemibold">
        ...
        {/* Input Fields */}
        <p className="text-white font-oxaniumsemibold text-[18px] mb-5">
          General
        </p>
        <div className="grid grid-cols-1 gap-4 md:grid-cols-2">
          <div>
            <label className="block mb-1 text-sm font-oxaniummedium">
              Market Type
            </label>
            <input
              type="text"
              placeholder="Enter Market Type"
              className="w-full px-4 py-2 font-oxaniummedium rounded bg-white/20 border border-gray-300 text-white placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-purple-500"
            />
          </div>
          <div>
            <label className="block mb-1 text-sm font-oxaniummedium">
            ...
            <input
              ...
              className="w-full px-4 py-2 rounded font-oxaniummedium bg-white/20 border border-gray-300 text-white placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-purple-500"
            />
          </div>
          <div>
            <label className="block mb-1 text-sm font-oxaniummedium">
        ...
        <p className="text-white font-oxaniumsemibold text-[18px] my-5">
          Stake Requirements
        </p>
        <div className="grid grid-cols-1 gap-4 md:grid-cols-2">
          <div>
        ...
        <div className="flex justify-center mt-10 ">
          ...
          <div className=" flex items-center justify-end  z-10 relative">
            ...
            <button
              onClick={onClose}
              className="border-[#AD1AAF] font-oxaniummedium border-2 py-2 px-10 hover:bg-transparent backdrop-blur-xl text-white hover:text-white bg-[#AD1AAF]"
            >
              Submit Proposal
            </button>
