      ...
      <div className="space-y-4">
        <div className="flex gap-4 items-center">
          <Textarea
            ...
            className="bg-transparent border-[#F81DFB] text-white font-oxaniummedium"
          />
          <Button className="bg-[#F81DFB] hover:bg-purple-700 font-oxaniummedium">
            Post
          </Button>
        </div>
          ...
          {[1, 2, 3].map((i) => (
            <div key={i} className="flex gap-4 mt-2">
              ...
              <div className="flex-1 rounded-r-xl rounded-bl-2xl bg-white/10 border-[#F81DFB] border p-4 backdrop-blur-xl">
                <p className="text-sm text-white font-oxaniummedium">
