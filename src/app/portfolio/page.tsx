  ...
  return (
    <Layout>
      <div className="mx-auto max-w-7xl p-4">
        <div className="pt-[30px] flex justify-center my-10">
        ...
        <div className="mx-[50px] my-16">
          <p className="font-oxaniummedium text-white text-[30px]">My Bets</p>
        ...
        <div className="mx-[50px] mt-20">
          <p className="font-oxaniummedium text-white text-[30px]">My NFTs</p>
