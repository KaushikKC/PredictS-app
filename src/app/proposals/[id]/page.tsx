      ...
      <div className="mx-auto max-w-7xl space-y-8 p-4">
            ...
            <div className="flex justify-between z-10 relative">
              ...
              <div className="ml-10 space-y-3">
                <div className="bg-gradient-to-br from-white/10 to-white/5 rounded-3xl p-3 text-white w-[140px] ">
                  <span className="text-sm font-oxaniumregular ">
                    Market Ends On{" "}
                  </span>
                  <span className="text-sm font-oxaniumregular text-white">
                    25 Dec, 2024
                  </span>
                </div>
                <div className="bg-gradient-to-br from-white/10 to-white/5 rounded-3xl p-3  text-white w-[140px]">
        ...
        <div className="grid gap-8 lg:grid-cols-3">
          <div className="lg:col-span-2 space-y-8">
            ...
            />
            <h3 className="text-xl font-bold text-white font-oxaniumbold">
              ABOUT
            </h3>
